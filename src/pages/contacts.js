  ...
  return (
    <div>
      <div style={{padding:'10px'}}> 
        ...
        <div className={styles.gridCard+' '+styles.contactaddr}>
          ...
          <div>
            <p><b>Address:</b><br />
            A Rd, Churchgate, Mumbai, Maharashtra 400020</p>
          </div>
        </div>
        <br />
